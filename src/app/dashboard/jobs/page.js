...
export default function Page() {
    ...
    const onSubmit = async (jobsData) => {
        ...
        const filterJobs = (rawJobs) => {
            const hiddenJobs =
                JSON.parse(localStorage.getItem("hiddenJobs")) || [];
        ...
        // console.log(data.hours_old);
        // console.log(typeof data.hours_old);
    ...
    return (
        <>
            <h1 className="flex items-center gap-3 text-3xl font-bold mb-1">
                <Briefcase color="#2b7fff" /> Explorador de Vagas
            </h1>

            <p className="text-muted-foreground w-3xl">
                Explore oportunidades de trabalho com recursos avançados de
                filtragem e acesso direto às principais plataformas, facilitando
                a identificação das vagas mais alinhadas ao seu perfil.
            </p>
