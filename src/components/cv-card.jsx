                ...
                <Card className="gap-5 cursor-pointer hover:translate-x-0.5 hover:-translate-y-0.5">
                    ...
                    <CardFooter className="flex justify-between items-center">
                        <a
                            ...
                            className="group flex items-center gap-2 text-blue-400 text-sm"
                        >
                            <Link2
                                size={18}
                    ...
                    <div className="max-w-lg w-full max-h-[70vh] space-y-4">
                        <DialogHeader className="p-2 flex flex-col gap-4 items-center">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group w-fit flex justify-center items-center gap-2 text-blue-400 text-sm cursor-pointer"
                            >
                                <Link2
                                    size={18}
                                    className="transition duration-200 group-hover:-translate-x-0.5"
